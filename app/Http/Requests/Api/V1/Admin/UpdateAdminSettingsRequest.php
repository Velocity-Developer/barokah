...
class UpdateAdminSettingsRequest extends FormRequest
{
    ...
    public function rulesForKey(string $key): array
    {
        ...
        return match ($key) {
            ...
            'security.recaptcha_version' => ['nullable', 'string', 'in:v2,v3'],
            'security.recaptcha_site_key', 'security.recaptcha_secret_key' => ['nullable', 'string', 'max:255'],
            'security.recaptcha_score_threshold' => ['nullable', 'numeric', 'min:0', 'max:1'],
