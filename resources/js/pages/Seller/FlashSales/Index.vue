...
import FlashSaleList from '@/components/flash-sales/FlashSaleList.vue';
...
<template>
    ...
    <FlashSaleList mode="seller" :flash-sales="flashSales as never" :filters="filters" :status-counts="statusCounts" />
</template>
